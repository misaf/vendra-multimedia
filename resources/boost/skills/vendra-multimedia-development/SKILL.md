...
- Add or update focused Pest coverage, then run `composer --working-dir=packages/vendra-multimedia test` and `composer --working-dir=packages/vendra-multimedia analyse`.
